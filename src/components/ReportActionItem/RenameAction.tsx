...
function RenameAction({currentUserPersonalDetails, action}: RenameActionProps) {
    ...
    const originalMessage = action.actionName === CONST.REPORT.ACTIONS.TYPE.RENAMED ? getReportActionOriginalMessage<OriginalMessageRenamed['originalMessage']>(action) : null;
